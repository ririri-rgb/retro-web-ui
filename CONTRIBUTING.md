...
5. With Node.js 20.19+, run `npm ci`, `npm run build:fixtures`, and `npm audit --omit=dev --audit-level=moderate`.
...
8. Record new compatibility evidence and limitations honestly.
9. Do not contribute extracted Microsoft assets or third-party material without explicit redistribution rights and notices.
