...
class UnifiedCLITests(unittest.TestCase):
    ...
    def test_info_has_stable_envelope_and_matching_manifest(self):
        ...
        self.assertEqual(document["tool"]["version"], "1.1.0.dev0")
...
class RepositoryTests(unittest.TestCase):
    ...
    def test_development_versions_are_aligned(self):
        ...
        self.assertEqual((ROOT / "VERSION").read_text(encoding="utf-8").strip(), "1.1.0.dev0")
        self.assertEqual(manifest["skill_version"], "1.1.0.dev0")
        self.assertIn('TOOL_VERSION = "1.1.0.dev0"', contracts)
        self.assertIn('version = "1.1.0.dev0"', pyproject)
